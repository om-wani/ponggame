...
document.addEventListener('keydown', (event) => {
    ...
    if (code === 'ArrowUp' || code === 'KeyI') {
        keyPressed['Up'] = true;
    }
    if (code === 'ArrowDown' || code === 'KeyK') {
...
window.onload = function(){
	alert("This is a simple game of pong, made using javascript.");
	alert("the Left (green-colored) player can be controlled using 'W' and 'S'.");
	alert("the Right (red-colored) player can be controlled using 'I' and 'K'.");
	alert("Clicking the OK button here will start the game.");
}
...
function gameOver(){
    if(game.leftScore === game.topScore){
        ...
        alert("Left Wins");
        alert("Clicking the OK button here will reset the game.");
        resetGame();
